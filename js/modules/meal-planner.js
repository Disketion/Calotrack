    ...
    getNutritionAdvice(bmi, goal) {
        ...
        const advice = {
            obesity: {
                ...
                maintain: ['Для поддержания веса необходим строгий контроль калорий'],
            ...
            overweight: {
                ...
                gain: [
                    'Набор массы требует интенсивных тренировок',
            ...
            underweight: {
                ...
                maintain: ['Требуется набор массы до нормальных показателей'],
                gain: [
